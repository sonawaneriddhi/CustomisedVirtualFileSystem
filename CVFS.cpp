...
//
//  File Name   : CVFS.cpp
//  Dscription  : This project emulates file system functionality to create a virtual 
...
typedef struct FileTable        //opened files
{
    int ReadOffset;
    int WriteOffset;
    int Count;
                ...
                )
{
    ...
    //No name provided of file to be unlinked
    if(name == NULL)
    {
        return ERR_INVALID_PARAMETER;
    }
...
)
{
    ...
    //Write data sucessfully at the end of file
...
int main()
{
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                //system("cls");
                cout << "\e[1;1H\e[2J"; // ANSI escape codes for clearing the screen
                cout.flush();
            }
